  ...
  if (update.message) {
    ...
    if (state[userId]) {
      ...
      if (s.step === 'name') {
        ...
        await send(chatId,
          '\u2705 <b>\u0e25\u0e07\u0e17\u0e30\u0e40\u0e1a\u0e35\u0e22\u0e19\u0e2a\u0e33\u0e40\u0e23\u0e47\u0e08\u0e41\u0e25\u0e49\u0e27! / Registration Complete!</b>\n\n\u0e41\u0e2d\u0e14\u0e21\u0e34\u0e19\u0e08\u0e30\u0e15\u0e34\u0e14\u0e15\u0e48\u0e2d\u0e01\u0e25\u0e31\u0e1a\u0e43\u0e19\u0e40\u0e23\u0e47\u0e27\u0e46 \u0e04\u0e23\u0e31\u0e1a\nOur admin will contact you shortly.\n\n๐‘ค @clubhouse72',
          [[{ text: '\u0e01\u0e25\u0e31\u0e1a / Back', callback_data: 'back' }]]
        );
      }
      return;
    }
    ...
    if (text === '/start') {
      await send(chatId,
        ...
        [[{ text: '\u0e25\u0e07\u0e17\u0e30\u0e40\u0e1a\u0e35\u0e22\u0e19 / Register Now', callback_data: 'register' }]]
      );
    }
  }
